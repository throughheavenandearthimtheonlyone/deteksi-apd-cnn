...
while cap.isOpened():
    ...
    # Display the frame
    if has_ppe:
        cv2.putText(frame, "Ball Terdeteksi", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
    else:
        cv2.putText(frame, "Ball Tidak Terdeteksi", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
